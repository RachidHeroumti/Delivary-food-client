    ...
    <div className='max-w-[1640px] m-auto px-4 py-12 text-xl'>
      ...
      <div className='lg:flex justify-between'>
        ...
        <div className='py-5'>
          ...
          <div className=''>
            <button className='rounded-lg px-5 text-orange-500 border border-orange-500 hover:bg-orange-500 hover:text-white mx-1' onClick={() => { filterPrice("$") }}>Lowest</button>
            <button className='rounded-lg px-5 text-orange-500 border border-orange-500 hover:bg-orange-500 hover:text-white mx-1' onClick={() => { filterPrice("$$") }}>Highest</button>
          </div>
        </div>
      </div>
        ...
        {food.map((item, i) => (
          <div className='border shadow-lg hover:scale-105 duration-300 rounded-lg' key={i}>
            ...
            <div className='flex p-5 space-x-5 text-white text-xl'>
              <button
               className='rounded-full hover:bg-gray-100 text-orange-500 border border-orange-600 px-2 p-1 flex justify-center items-center space-x-2'>
                <span>Buy On</span>  <FaWhatsapp size={25} className='text-green-600' />
              </button>
              <button className='bg-gry-50 rounded-full hover:bg-orange-600 space-x-2 border bg-orange-500 px-2 p-1 flex justify-center items-center' onClick={() => { OnAddToCart(item) }}>
